...
export function SiteBuilder() {
  ...
  // Fetch current user's site data
  ...
  // Fetch current user info for site URL
  ...
  // Update form data when site data loads
  React.useEffect(() => {
    if (siteData) {
      setFormData({
        name: siteData.name || '',
  ...
  const getUserSiteUrl = () => {
    ...
    // Create a clean username from user ID
