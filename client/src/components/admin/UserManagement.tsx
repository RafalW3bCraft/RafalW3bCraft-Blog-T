 ...
 * Implements the missing admin functionality identified in the audit
 */
...
export function UserManagement({ onClose }: UserManagementProps) {
  ...
  // Individual user update mutation
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <Badge
                          ...
                          className={user.role === 'admin' ? 'border-red-500 text-red-400' : 
                                   user.role === 'moderator' ? 'border-yellow-500 text-yellow-400' :
                        ...
                        <Badge
                          variant="outline"
                          className={getRiskBadgeColor(user.riskScore)}
                        >
                      ...
                      <div className="flex items-center space-x-4 text-xs text-gray-500">
                        ...
                        <span>Activity: {user.activityCount} actions</span>
                      </div>
