/**
 * Admin User Security Management Component
 * Provides comprehensive user monitoring and security actions
 */
...
export function AdminUserSecurityManager() {
  ...
  // Fetch user activities with security data
