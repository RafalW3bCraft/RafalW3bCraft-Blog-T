...
export class ContentModerationService {
  ...
  constructor() {
    // Basic bad words list - can be expanded
    this.badWords = new Set([
      'spam', 'scam', 'fake', 'fraud', 'phishing',
      // Add more as needed - focusing on cybersecurity context
    ]);
    // Cybersecurity-specific terms are allowed by default in our custom implementation
  }
  ...
  async moderateContent(
    ...
    // AI-powered moderation (if enabled and API key available)
  ...
  // Admin functions for reviewing flagged content
