...
export class RealTimeAnalytics {
  ...
  private setupEventHandlers() {
    this.io.on('connection', (socket) => {
      ...
      // Handle security dashboard requests
      ...
      socket.on('disconnect', () => {
        ...
        // Remove from active users if this was their only connection
  ...
  private async getRecentSecurityEvents(): Promise<SecurityEvent[]> {
    try {
      // Get audit logs from last hour with security-related activities
  ...
  private cleanupInactiveUsers() {
    // In a real implementation, you'd track user sessions more precisely
    // For now, we'll clear inactive users periodically
    setTimeout(() => {
